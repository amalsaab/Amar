...
<img width={100} src={Aqar} alt="" />
  ...
  <div class="p-6" >
    <h1 class="block mb-2 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">عمر العقار:  {props.Age}</h1>
    <h1 class="block mb-2 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900"> عدد الوحدات المتاحة: {props.NumberofUnit}</h1>
  </div>
  <div class="p-6 pt-0">
    <Link to='/Apartment'>
      <button
