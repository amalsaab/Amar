...
const SenderContentTenant = (probs) => {
  return (
    <div>
      <div className="flex flex-col text-xl p-3 gap-2 border-l-2">
        ...
        <div className="flex flex-col gap-1">
          <div>اسم الطلب: {probs.RequestName} </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-3 ">
              {probs.RequestStatus === "قيد التنفيذ" && (
                <div className="bg-secondary py-2 w-28 rounded-lg text-center text-gray-400">
                  قيد التنفيذ
                </div>
              )}
              {probs.RequestStatus === "مقبول" && (
                <div className="bg-accent py-2 w-24 rounded-lg text-center text-gray-500">
                  مقبول
                </div>
              )}
...
export default SenderContentTenant;
