  ...
  <div className="drawer-content items-center justify-center DashboredBG ">
    ...
    <div className='bg-white outline outline-[#BBA98D] flex justify-between items-center m-10 rounded-md w-full p-4'>
        ...
        <div className='flex flex-col' >
            <h1 className='text-[2rem] font-bold  '>اضافة شقة</h1>
...
<label htmlFor="idLand" className='w-24'>رقم الشقة</label>
  <input className='outline outline-gray-200 rounded-md  w-48' type="text"  />


  <label htmlFor="dateLand" className='w-24'>رقم العقد</label>
  <input  className='outline outline-gray-200 rounded-md w-48' type="text" />
</div>
<div className=' w-full flex justify-between gap-5'>
  <label htmlFor="locationLand" className='w-24'>رقم الطابق</label>
  <input  className='outline outline-gray-200 rounded-md  w-48' type="text" />

  <label htmlFor="locationLand" className='w-24'>حساب الكهرباء</label>
  <input  className='outline outline-gray-200 rounded-md  w-48' type="text" />
