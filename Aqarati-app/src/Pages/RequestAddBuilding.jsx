...
export default function RequestAddBuilding() {
  return (
<>
  ...
  <div className="drawer-content items-center justify-center DashboredBG ">
    ...
    <div className='bg-white outline outline-[#BBA98D] flex justify-between items-center m-10 rounded-md w-full p-4'>
        ...
        <div className='flex flex-col' >
            <h1 className='text-[2rem] font-bold  '> اضافة عقار جديد</h1>
      ...
      <div className='flex justify-end  ml-10 '>  <button  className=' flex flex-row-reverse items-center'> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
</svg>
انتقال للخلف</button></div>
...
<label htmlFor="idLand" className='w-20'>رقم الصك</label>
  <input className='outline outline-gray-200 rounded-md  w-48' type="text"  />


  <label htmlFor="dateLand" className='w-20'>تاريخ الصك</label>
  <input  className='outline outline-gray-200 rounded-md w-48' type="date" />
</div>
<div className=' w-full flex justify-between gap-5'>
  <label htmlFor="locationLand" className='w-20'>المدينة</label>
  <input  className='outline outline-gray-200 rounded-md  w-48' type="text" />

<label htmlFor="sizeLand" className='w-20'> اسم العقار</label>
  <input  className='outline outline-gray-200 rounded-md  w-48' type="text" />
</div>
<div className='flex flex-row-reverse gap-5 '>  <label className='' htmlFor="terms">اتعهد ان جميع الحقول صحيحة</label>
  <input type="checkbox" />
</div>
