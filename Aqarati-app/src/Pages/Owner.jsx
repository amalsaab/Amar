          ...
          <div className="drawer-content items-center justify-center DashboredBG   ">
            ...
            <div className="flex w-full  items-center justify-center  ">
              <div className="bg-white outline outline-primary flex justify-center items-center m-10 rounded-md  p-4 gap-4 flex-wrap">
                {/* <div className="flex "> */}
                <button className="btn btn-xs btn-primary sm:btn-sm md:btn-md lg:btn-md">
                  اضافة عقار
                </button>
                <button className="btn btn-xs btn-primary sm:btn-sm md:btn-md lg:btn-md">
                  اضافة شقة
          ...
          <div className="drawer-side">
            ...
            <ul className="menu  w-80 min-h-full bg-white text-base-content text-[1.3rem] justify-between">
              ...
              <div className="w-full">
                ...
                <li className={selected.aqar ?"flex mt-10 bg-primary rounded-lg text-white":"flex pt-10"}>
                  <button 
                  onClick={() => setSelected({
                    aqar: true,
                    tqar: false,
                    ...
                    <p className={selected.aqar ?"text-white":"text-black"}>عقاراتي</p>
                  </button>
                </li>
                <li className={selected.tqar ?"bg-primary rounded-lg ":""}>
                  ...
                  onClick={() => setSelected({
                    ...
                    <p className={selected.tqar ?"text-white":"text-black"}>التقارير</p>
                  </button>
                </li>
                ...
                <li className={selected.syan ?"bg-primary rounded-lg ":""}>
                  ...
                  onClick={() => setSelected({
                    ...
                    <p className={selected.syan ?"text-white":"text-black"}>الصيانة</p>
                  </button>
                </li>
                ...
                <li className={selected.profile ?"bg-primary rounded-lg ":""}>
                  <button 
                  onClick={() => setSelected({
                    aqar: false,
                    tqar: false,
                    ...
                    <p className={selected.profile ?"text-white":"text-black"}>الملف الشخصي</p>
                  </button>
                </li>
              </div>
